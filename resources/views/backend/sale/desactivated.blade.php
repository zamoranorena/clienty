...
@section('content')
  <div class="box box-success">
    <div class="box-header with-border">     
      <h3 class="box-title">Ventas Eliminadas</h3>
            ...
            @endphp
              @foreach($sales as $venta)
                <tr>
                  ...
                  <td>
                      @permission('restaurarventas')
                        <div class="form-group">
                          {{ Form::open(['method' => 'DELETE', 'route' => ['admin.operation.sale.restore', $venta->id],'class'=>'restaurar']) }}
                            <button type="submit" data-toggle="tooltip" data-placement="top" title="Restaurar Venta" class="btn btn-info"><i class="fa fa-refresh" ></i></button>
                          {{ Form::close() }}
                        </div>
                      @endauth 
                  </td>
    ...
    <script>
      ...
      $( ".restaurar" ).submit(function( event ){
        ...
        var tabla = $( "#sales-table tbody tr" ).length;
          swal({
            title: "¿Desea restaurar esta venta?",
            type: "warning",
