...
<div class="box-header with-border">
   <h3 class="box-title">Metas de ejecutivos de ventas</h3>
...
<div class="box-body">
   <div class="container">
         ...
         @foreach($utilidades_counters as $uti)
     ...
     <div class="col-md-12">
            ...
            <div class="progress-group">
                              <span class="progress-text">{{ $uti->counter}}</span>
               <span class="progress-number"><b>$ {{$uti->suma}} /$ 5,000 </b></span>
               <?php $por=(str_replace(",","",$uti->suma)/5000)*100; ?>
               <div class="progress xl">
                  <div class="progress-bar" style="width: <?php echo $por."%" ?> ;background-color: #6E6E6E"></div>
               </div>
            </div>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <?php  }if(empty($visita["quote_id"])){
                           ?>
                           {{Form::open(['method' => 'DELETE', 'route' => ['admin.operation.visit.destroy',$visita->visita_id],'class'=>'eliminar']) }}
                          ...
                          <a>
                            <button type="submit" data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-info" ><i class="fa fa-trash" ></i></button></a>
                                {{Form::close() }}                   
