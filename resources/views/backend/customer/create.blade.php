...
<link href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.3/css/select2.min.css" rel="stylesheet"/>
    ...
    <h1>
        Gestión de Clientes
        <small>Crear Clientes</small>
    </h1>
@endsection

@section('content')
 {!! Form::open(array('route'=>'admin.maintenance.customer.store','method'=>'POST','class'=>'form-horizontal formulariocrear'))!!}
      ...
      <div class="col-md-12">
    <div class="col-md-4">
    <div class="form-group input-lg" style="margin-left: 0; margin-right: 0">
