...
@section('page-header')
    <h1>
        Gestión de Roles
        <small>{{ trans('Editar Roles') }}</small>
    </h1>
    <ul class="breadcrumb">
        <li><a >Dashboard</a></li>
        <li><a >Roles</a></li>
    ...
    {{ Form::model($role, ['route' => ['admin.access.role.update', $role], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-role']) }}
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('Editar Roles') }}</h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        @if ($role->id != 1)
                            ...
                            {{ Form::select('associated-permissions', ['all' => 'Todos', 'custom' => 'Personalizado'], $role->all ? 'all' : 'custom', ['class' => 'form-control']) }}
                        @else
                ...
                <div class="form-group">
                    {{ Form::label('sort', trans('Orden'), ['class' => 'col-lg-2 control-label']) }}
